/*
 * cksum.h - utilities for calculating checksums
 */
...
/**
 * cksum_internet - performs an internet checksum on a buffer
 * @buf: the buffer
 ...
 */
static inline uint16_t cksum_internet(const void *buf, int len)
{
    uint64_t sum;
