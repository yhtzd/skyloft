/*
 * cksum.h - network checksum routines
 */
 ...
 */
static inline uint16_t ipv4_phdr_cksum(uint8_t proto, uint32_t saddr, uint32_t daddr,
                                       uint16_t l4len)
{
...
static inline uint16_t ipv4_udptcp_cksum(uint8_t proto, uint32_t saddr, uint32_t daddr,
